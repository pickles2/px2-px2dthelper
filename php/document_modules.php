...
class document_modules{
	 ...
	 * スタイルガイドを生成
	 * 
	 * ※このAPIの開発は一時中止し、削除します。
	 * 　コンテンツのビルド処理がJavaScriptコードに依存し、PHP上での実現が困難または非効率的となる可能性があるためです。
	 * 　モジュールの仕様の方針によっては、将来に開発が再開されるかもしれません。あるいは、別の場所でJavaScriptライブラリとして提供される可能性があります。
	 * 
