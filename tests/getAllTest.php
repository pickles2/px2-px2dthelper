...
class getAllTest extends PHPUnit_Framework_TestCase{
	...
	public function testGetAll(){
		...
		// page_originated_csv
		$output = json_decode($this->passthru( ['php', __DIR__.'/testData/standard/.px_execute.php', '/?PX=api.get.page_originated_csv&path=/' ] ));
	...
	public function testGetAllPathFilesIsFunction(){
		...
		// path_homedir
		$this->assertEquals( $json->path_homedir, '.'.DIRECTORY_SEPARATOR.'px-files'.DIRECTORY_SEPARATOR );
