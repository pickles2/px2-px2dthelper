...
class px2ceTest extends PHPUnit\Framework\TestCase{
	...
	/**
	 * Pickles 2 Contents Editor GPIのテスト
	 */
	public function testGpi(){
		...
		$output = $this->passthru( [
			...
			'/guiedit/index.html?PX=px2dthelper.px2ce.gpi&data='.urlencode(base64_encode(json_encode(
				array(
					'api' => 'getConfig'
				)
			))) ,
